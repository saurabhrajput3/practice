...
public class PatientController {
    ...
    public Doctor suggestDoctorByPatientId(@RequestParam int id) throws NotValid {
    ...
    public Patient getPatientById(@RequestParam int id) throws NotValid {
        Patient p = service.getPatientById(id);
        return p;
    }

    @DeleteMapping("/deletePatientById")
    public ResponseEntity<String> deleteById(@RequestParam int id) throws NotValid {
