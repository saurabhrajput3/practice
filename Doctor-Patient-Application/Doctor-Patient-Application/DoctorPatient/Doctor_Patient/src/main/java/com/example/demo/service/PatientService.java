...
public class PatientService {
    ...
    public Doctor getDoctor(String city, String symptom, boolean flag) {
        ...
        if(!bySymptom.isEmpty()){
            int id = bySymptom.get(0).getSpeciality().getId();
    ...
    public Patient getPatientById(int id) throws NotValid {
    ...
    public Doctor getDoctorById(int id) throws NotValid {
        Doctor doc=null;
        if(!patientRepo.findById(id).isPresent()){
            throw new NotValid("No patient found with id -> "+id+" please consider providing valid id");
        }
    ...
    public void deleteById(int id) throws NotValid {
        if(!patientRepo.findById(id).isPresent()){
            throw new NotValid("No patient found with id -> "+id+" please consider providing valid id");
        }
